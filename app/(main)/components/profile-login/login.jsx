  ...
  return (
    <div className="w-[80%] relative h-[80%] rounded-[20px] border-[#ffffff0f] border overflow-hidden">
      <div
        ...
        items-center top-0 h-full w-[70%]
        ${loginForm 
          ? "right-0 rounded-r-[20px] rounded-l-[120px]" 
          : "left-0 rounded-l-[20px] rounded-r-[120px]"}
        bg-black border border-[#ff6a00] text-[#ff6a00]`}
      >

        <h1 className="text-[40px] font-[sans-serif] mt-8 text-[#ff6a00]">
        ...
        <form className="flex flex-col gap-5 mt-10 w-[70%]">
          ...
          <input
            ...
            className="h-[50px] px-4 rounded-lg outline-none transition-all
              border border-[#ff6a00] bg-black text-[#ff6a00] placeholder-gray-500 
              focus:border-[#ff6a00] focus:ring-2 focus:ring-[#ff6a00]/40"
          />
        ...
        <button
          ...
          rounded-lg border border-[#ff6a00] bg-black hover:bg-[#111] 
          transition-all shadow-sm text-[#ff6a00]"
        >
        ...
        <div className="flex items-center mt-5 gap-[6px] text-white">
